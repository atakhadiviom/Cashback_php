...
7. نصب‌کننده فایل تنظیمات را در مسیر پایدار بیرون از پوشه برنامه می‌سازد: `../cashback_config.php`.
8. نصب‌کننده فایل قفل نصب را هم بیرون از پوشه برنامه می‌سازد: `../cashback_installed.lock`.
